...
bool lab_amoro_interfaces__msg__states__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lab_amoro_interfaces.msg._states.States", full_classname_dest, 39) == 0);
  }
  lab_amoro_interfaces__msg__States * ros_message = _ros_message;
  {  // position
...
PyObject * lab_amoro_interfaces__msg__states__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lab_amoro_interfaces.msg._states");
