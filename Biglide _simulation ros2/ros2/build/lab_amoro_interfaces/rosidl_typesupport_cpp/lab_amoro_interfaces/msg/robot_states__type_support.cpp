...
static const _RobotStates_type_support_symbol_names_t _RobotStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab_amoro_interfaces, msg, RobotStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab_amoro_interfaces, msg, RobotStates)),
  }
};
...
{
  return &::lab_amoro_interfaces::msg::rosidl_typesupport_cpp::RobotStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lab_amoro_interfaces, msg, RobotStates)() {
  return get_message_type_support_handle<lab_amoro_interfaces::msg::RobotStates>();
}
