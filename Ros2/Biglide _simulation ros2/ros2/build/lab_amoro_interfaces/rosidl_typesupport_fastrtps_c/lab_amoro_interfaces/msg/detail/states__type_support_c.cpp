...
#include "lab_amoro_interfaces/msg/detail/states__rosidl_typesupport_fastrtps_c.h"
...
using _States__ros_msg_type = lab_amoro_interfaces__msg__States;
...
static uint32_t _States__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lab_amoro_interfaces__msg__States(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lab_amoro_interfaces__msg__States;
    is_plain =
      (
...
static size_t _States__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lab_amoro_interfaces__msg__States(
