...
static const _JointEfforts_type_support_symbol_names_t _JointEfforts_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lab_amoro_interfaces, msg, JointEfforts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lab_amoro_interfaces, msg, JointEfforts)),
  }
};
...
{
  return &::lab_amoro_interfaces::msg::rosidl_typesupport_cpp::JointEfforts_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lab_amoro_interfaces, msg, JointEfforts)() {
  return get_message_type_support_handle<lab_amoro_interfaces::msg::JointEfforts>();
}
